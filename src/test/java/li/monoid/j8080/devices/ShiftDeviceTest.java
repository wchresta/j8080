...
public class ShiftDeviceTest {
    ...
    public void trivial() {
        ...
        shiftDevice.receiveData((byte) 0x02, (byte) 0xaa);
        assertEquals("First push", (byte) 0xaa, shiftDevice.sendData((byte) 0x03));
        shiftDevice.receiveData((byte) 0x02, (byte) 0xff);
        assertEquals("Second push", (byte) 0xff, shiftDevice.sendData((byte) 0x03));
        shiftDevice.receiveData((byte) 0x02, (byte) 0x12);
    ...
    public void shift1() {
        ...
        shiftDevice.receiveData((byte) 0x04, (byte) 0x04);
        shiftDevice.receiveData((byte) 0x02, (byte) 0xaa);
